...
import com.example.myapplication.TransferLearningHelper
import com.example.myapplication.TransferLearningHelper.Companion.CLASS_FOUR
import com.example.myapplication.TransferLearningHelper.Companion.CLASS_ONE
import com.example.myapplication.TransferLearningHelper.Companion.CLASS_THREE
import com.example.myapplication.TransferLearningHelper.Companion.CLASS_TWO
...
class CameraFragment : Fragment(),
    ...
    override fun onResume() {
        ...
        if (!PermissionsFragment.hasPermissions(requireContext())) {
             Log.e("check quen","Check quen camera")
